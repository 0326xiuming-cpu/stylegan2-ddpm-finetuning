...
def score_image(path):
    ...
    return sharpness * 0.3 + brightness_sc * 100 * 0.5 + contrast_sc * 100 * 0.2
...
os.makedirs("final_brightness", exist_ok=True)
for idx, (_, fname) in enumerate(top1000):
    copyfile(f"temp_2000/{fname}", f"final_brightness/img_{idx:04d}.png")

print(f"완료! final_brightness에 {len(top1000)}장")

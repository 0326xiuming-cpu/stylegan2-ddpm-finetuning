...
def score_image(path):
    ...
    return sharpness * 0.8 + brightness_sc * 100 * 0.15 + contrast_sc * 100 * 0.05
...
os.makedirs("final_sharpness", exist_ok=True)
for idx, (_, fname) in enumerate(top1000):
    copyfile(f"temp_2000/{fname}", f"final_sharpness/img_{idx:04d}.png")

print(f"완료! final_sharpness에 {len(top1000)}장")
